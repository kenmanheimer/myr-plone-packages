# Myriadicity Website Plone Packages Devops
...
Also, add a `prod.yml` file to `inventory` folder (with information about the production server), and a `kenmanheimer-prod.yml` to `host_vars` folder.
